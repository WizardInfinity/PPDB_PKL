...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background-color:rgb(0, 0, 0) ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <strong><a class="nav-link active" aria-current="page" ><i class="bi bi-person-fill"></i>  Guest</a></strong>
            </li>
            <li class="nav-item mx-3">
                <a class="nav-link active" aria-current="page" href="{{ url('website') }}">Home</a>
            </li>
            <li class="nav-item mx-3">
                <a class="nav-link active" data-bs-toggle="modal" data-bs-target="#exampleModalsatu" href="#">Pendaftaran Online</a>
            </li>
            <li class="nav-item mx-3">
                <a class="nav-link active" data-bs-toggle="modal" data-bs-target="#exampleModalsatu" href="#">Status Penerimaan </a>
            </li>
            <li class="nav-item mx-3">
                <a class="nav-link active" data-bs-toggle="modal" data-bs-target="#exampleModalsatu" href="#">Hasil Peserta</a>
            </li>
            <span class="navbar-text mx-3">
                <a class="btn btn-success btn-sm bi bi-arrow-down-circle" href="{{ url('login') }}">  Log-In   </a>
            </span>
        </div>
        </div>
    </nav>
    ...
    <footer class="bg-dark  text-white">
        ...
        <div class=" p-3" style="background-color: rgba(0, 0, 0, 0.2);">
                <div><a>Website Pendaftaran Peserta Didik Baru</a></div>
...
<!-- Modal 1 -->
<div class="modal fade" id="exampleModalsatu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel"><b>KONFIRMASI</b></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
        <i>Oppss Kamu Belum Login...</i> Login Untuk Melihat Website
        </div>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    @if ($message = Session::get('success'))
        <script>
            Swal.fire({
                icon: 'success',
                title: 'Terimakasih Telah Mengunjungi Website Kami...',
                text: '{{ $message  }}',
